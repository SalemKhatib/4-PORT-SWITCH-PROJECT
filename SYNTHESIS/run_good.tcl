...
# 6. COMPILE (OPTIMIZED)
compile_fusion -gate_clock -to final_opto

# 7. GENERATE REPORTS
report_power > report_power_GOOD.txt
report_area > report_area_GOOD.txt
report_clock_gating > report_clock_gating_GOOD.txt
report_timing > report_timing_GOOD.txt

# 8. SAVE NETLIST
write_verilog -hierarchy all switch_4port_GOOD.v
write_sdf switch_4port_GOOD.sdf
